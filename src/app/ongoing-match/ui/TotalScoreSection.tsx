            ...
            <Grid item size={{xs: 6}}>
                <Grid container direction="column" alignItems="center">
                    <Box
                        ...
                        <Typography variant="h6" color="#fff">{leftWins}</Typography>
                    </Box>
                    <Typography variant="h1" fontWeight="bold">{leftScore}</Typography>
            ...
            <Grid item size={{xs: 6}}>
                <Grid container direction="column" alignItems="center">
                    <Box sx={{
                        ...
                        <Typography variant="h6" color="#fff">{rightWins}</Typography>
                    </Box>
                    <Typography variant="h1" fontWeight="bold">{rightScore}</Typography>
